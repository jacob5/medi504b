...
#### Table 3. Assessing fit and accuracy for three different variable combinations
...
### Table 2. Comparison of regularization methods across two models for predicting PCOS status
...
#### Figure 4. Comparative performance on the training data

```{r echo=FALSE, include=TRUE, fig.width=3, fig.height=3, fig.align = 'center'}
...
#### Table 3. Comparative performance of two models across three different modelling methodologies
