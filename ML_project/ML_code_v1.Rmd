...
```{r pruned_table, echo=FALSE, message=FALSE, warning=FALSE, results="hide"}
table1::table1(~
age_yrs+              
bmi+                  
pulse_rate_bpm+      
...
### Appendix Section 6 - Model cross-validation (without RIDGE or LASSO) (using the caret package)
...
### Appendix Plot 7 - Variable importance (based on Random Forest model)
```{r echo=FALSE, message=FALSE, warning = FALSE, results = "hide"}
