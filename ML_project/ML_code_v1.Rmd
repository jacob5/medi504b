...
```{r echo=FALSE}
row <-  c("ElasticNet: Clinical Parameters", 
round(as.numeric(mean(fit.cv.bin.elastic.model_3$results[,3])),4), 
round(as.numeric(mean(fit.cv.bin.elastic.model_3$results[,4])),4), 
round(as.numeric(mean(fit.cv.bin.elastic.model_3$results[,5])),4))
row2 <-  c("ElasticNet: Clinical and Physiological Parameters", 
round(as.numeric(mean(fit.cv.bin.elastic.model_2$results[,3])),4), 
round(as.numeric(mean(fit.cv.bin.elastic.model_2$results[,4])),4), 
round(as.numeric(mean(fit.cv.bin.elastic.model_2$results[,5])),4))
