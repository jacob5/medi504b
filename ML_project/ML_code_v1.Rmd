...
#### Appendix plot 2, as part of EDA, bivariate analysis examining correlations between continuous features 
...
```
* Boxplots showing the distributions of continuous variables in our dataset, stratified by PCOS status. 
