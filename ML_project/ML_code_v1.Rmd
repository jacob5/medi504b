...
#### Appendix Plot 3. ROC curves: physiological model (red) vs. clinical model (blue) vs. clinical and physiologic model (green)
...
### Appendix Plot 4 - Variable importance (based on Random Forest model)
```{r echo=FALSE, message=FALSE, warning = FALSE, results = "hide"}
