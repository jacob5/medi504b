...
2: Optimize the model for specificity, thus minimizing the risk of a false positive in model predications. 
...
```{r EDA2, eval=FALSE, fig.height=10, fig.width=20, message=FALSE, warning=FALSE, include=FALSE, results=}
