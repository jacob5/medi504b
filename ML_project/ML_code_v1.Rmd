...
### Table 1. Selected patient characteristics stratified by PCOS status
...
#### Figure 2. ROC curves: clinical model (blue) vs. clinical and physiologic model (green)
...
```{r echo=FALSE, include=TRUE, fig.width=8, fig.height=6}
